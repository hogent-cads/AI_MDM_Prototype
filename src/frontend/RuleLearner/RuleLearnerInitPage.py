    ...
    def show(self):
        with self.canvas.container():
            ...
            if chosen_tab == "3":
                ...
                with colB:
                    v = st.selectbox(
                        "Default Condition:", [e.value for e in DroppingEnum]
                    )
                ...
                with colC:
                    ...
                    with col2:
                        vw_specific = st.selectbox(
                            "Condition:", [e.value for e in DroppingEnum]
                        )
                    with col3:
