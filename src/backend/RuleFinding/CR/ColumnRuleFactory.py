...
class ColumnRuleFactory:
    ...
    def create_dict_of_dict_of_column_rules_from_list_of_strings(
    ...
    def transform_list_of_column_rules_to_dict_of_column_rules(
        self, column_rules: Sequence[ColumnRule]
    ) -> Dict[str, Sequence[ColumnRule]]:
        """
        ...
        for column_rule in column_rules:
            if math.isclose(column_rule.confidence, 1.0):
                ...
                if inverse_rule_string in rules_with_confidence_one:
                    ...
                    result["Definitions"][
                        rules_with_confidence_one[inverse_rule_string].rule_string
                    ] = rules_with_confidence_one[inverse_rule_string]
